...
function Mypage() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://port-0-regobackend-mbhas4h3dc26f757.sel4.cloudtype.app/mypage/${userid}`)
      .then(res => {
...
Promise.all(
  toDelete.map(id =>
    axios.delete(`https://port-0-regobackend-mbhas4h3dc26f757.sel4.cloudtype.app/selling/${id}`)
  )
)
  .then(() => {
